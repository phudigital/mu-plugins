...
- `brand-widget`: thêm widget “Thông tin & Hỗ trợ - PDL” trong Dashboard, đọc dữ liệu từ `https://hosting.pdl.vn/brand.json` và liên kết quản trị tới `https://hosting.pdl.vn/`.
